 ...
 * - الجنس: إجباري للكادر الصحيي (ذكر أو أنثى)
...
export const registerSchema = z
  .object({
    // الافتراضي: كادر صحي — للتوافق مع أي طلبات قديمة لا تُرسل الحقل
    ...
    // حقول خاصة بالكادر الصحي والطبيب — التخصص إجباري (تُفحص في superRefine)
  ...
  .superRefine((data, ctx) => {
    ...
    // بيانات الكادر الصحي والطبيب: المؤهل والجنس والتخصص وسنوات الخبرة كلها إلزامية
