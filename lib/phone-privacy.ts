 ...
 * =====================================================================
 * القاعدة المعتمدة من صاحب المنصة (محدّثة في الجولة 48 — اتصال متناظر بعد السداد):
 *  - رقم الكادر الصحي/الطبيب مخفي عن المستلم الإداري ومشرف الأطباء،
 ...
 *  - بيانات اتصال المستلم الإداري ومشرف الأطباء للكادر الصحيي/الطبيب
 *    (القاعدة الجديدة — الجولة 48، البلاغ الحرفي: «بعد تاكيد الدفع يجب ان
 *    يظهر بيانات الاتصال حتى انتهى التكليف» و«في تقديماتي يبقى رقم التواصل
 *    مغلق رغم انه تم تاكيد الدفع»):
 *      تُفتح للكادر بعد تأكيد الإدارة سداد الرسوم (أو في التكليفات بلا أي
 *      رسوم — الجولة 45) أثناء سير التكليف حصراً، وتُغلق تلقائياً فور
 *      إنهائه أو إلغائه — التناظر الكامل مع اتجاه الكادر→المستلم.
 *    (تُلغي هذه القاعدة «القفل باتجاه واحد» للجولة 38 الذي كان يحجب
 *    الاتصال عن الكادر حتى بعد تأكيد الدفع — وهو البلاغ الحرفي).
 *    وتظل بيانات الاتصال مُدارة من الخادم حصراً — لا يُرسل الرقم الكامل
 *    للمتصفح قبل تحقق الشرط.
...
/**
 * تلميح اتصال المستلم/المشرف المعروض للكادر عند القفل — الجولة 48:
 * القفل مؤقت — يُفتح بعد تأكيد الإدارة سداد الرسوم أثناء السير (أو بلا رسوم)
 * ويُغلق تلقائياً بعد الإنهاء/الإلغاء (تناظر كامل مع اتجاه الكادر→المستلم).
 */
export const RECEIVER_CONTACT_LOCKED_HINT =
  'بيانات اتصال المستلم الإداري ومشرف الأطباء تُفتح لك بعد تأكيد الإدارة سداد رسوم التكليف أثناء سيره (وتفتح مباشرة في التكليفات بلا رسوم)، وتُغلق تلقائياً بعد إنهائه'
 ...
 * عند انهاء التكليف من كلا من الكادر الصحي والطبيب والمستلم الإداري أو
 * مشرف الأطباء»:
 ...
 *  - أي تكليف فيه رسوم → يُفتح بعد تأكيد الإدارة سداد الرسوم (الجولة 48:
 *    الاتصال مفتوح للطرفين معاً أثناء السير — تناظر كامل).
...
/**
 * رقم المستلم الإداري/مشرف الأطباء كما يراه الكادر الصحي/الطبيب — الجولة 48:
 * القاعدة الموحدة isAssignmentContactOpen في الاتجاهين — الرقم الكامل يُرسل
 * أثناء سير التكليف المسدد (بعد تأكيد الإدارة الدفع) أو بلا أي رسوم،
 * ويُغلق فوراً عند الإنهاء/الإلغاء — تناظر كامل بين الطرفين.
 * (الجولة 38 القديمة — قفل مطلق باتجاه واحد — أُلغيت بالبلاغ الحرفي.)
 */
