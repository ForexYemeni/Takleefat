  ...
  if (posts.length === 0) {
    return (
      <EmptyState
        ...
        description="أنشئ أول تكليف ليظهر للكادر الصحيي ويقدّم عليه — ثم راجع سيرهم الذاتية واعتمد الأنسب."
      />
    )
  }
...
function CompleteAssignmentDialog({
  ...
  // حصراً (الكادر لا يُنهي إلا بعد اكتمال الوقت) — مع سبب إلزامي
          ...
          {isEarlyEnd && (
            <div className="rounded-2xl border-2 border-amber-300 bg-gradient-to-bl from-amber-50 to-transparent p-4 dark:border-amber-800 dark:from-amber-950/30">
              ...
              <p className="mt-1 text-xs leading-relaxed text-amber-700 dark:text-amber-300">
                ...
                التكليف ويُرسل للكادر بشفافية كاملة.
              </p>
              <div className="mt-3 space-y-1.5">
                ...
                <Textarea
                  id="early-end-reason"
                  rows={2}
                  placeholder="مثال: تعذر اكتمال المناوبة لظرف تشغيلي طارئ في الجهة — تم التنسيق مع الكادر"
                  value={reason}
