...
const FEATURES = [
  ...
  },
  {
    icon: ShieldCheck,
    title: 'صلاحيات محكمة',
    description: 'ثلاثة أدوار واضحة: مدير النظام، الكادر الصحي، والمستلم الإداري — مع حماية كاملة لجميع واجهات البرمجة.',
  },
  {
    icon: Users,
    title: 'سجل شفاف',
...
const STEPS = [
  {
    number: '١',
    title: 'أنشئ حسابك',
    description: 'سجّل بياناتك المهنية ككادر صحي، وارفع مستنداتك الرسمية خلال دقائق.',
  },
  {
    number: '٢',
    title: 'اعتماد الحساب',
