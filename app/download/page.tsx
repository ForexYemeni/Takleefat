...
const INSTALL_STEPS = [
  ...
  },
  {
    ...
    body: 'عند أول فتح سيسألك النظام عن إذن الإشعارات — وافق. سجّل دخولك وسيرتبط جهازك بحسابك تلقائياً وتبدأ التنبيهات الأصلية فوراً — بلا كروم وبلا أي إشعارات موقع.',
  },
]
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'الحد الأدنى: الإنترنت والإشعارات وخدمة التنبيهات في الخلفية. لا يطلب الوصول للصور أو جهات الاتصال أو الموقع الجغرافي. لضمان وصول التنبيهات على الأجهزة القاسية قد يطلب استثناء من تحسينات البطارية — اختياري وموصى به فقط.',
  },
  {
    icon: BellRing,
    q: 'هل تظهر إشعارات المتصفح التحذيرية (إشعار قد يكون غير مرغوب)؟',
    a: 'لا. منذ الإصدار 2.0.0 التنبيهات أصلية من التطبيق نفسه بقناة أندرويد النظامية باسم «تكليفات» — لا علاقة لها بكروم ولا بأي متصفح، ولا تظهر أي تحذيرات إشعارات موقع إطلاقاً.',
  },
]
        ...
        <div className="mx-auto grid max-w-5xl items-center gap-8 px-4 py-12 md:grid-cols-[1fr_auto] md:py-16">
          <div>
            ...
            <p className="mt-4 max-w-xl text-muted-foreground md:text-lg">
              ...
              وتصلك التنبيهات <strong className="text-foreground">إشعارات أصلية من التطبيق نفسه</strong>{' '}
              بقناة أندرويد النظامية، حتى لو كان مغلقاً تماماً <strong className="text-foreground">وبلا أي وسيط متصفح</strong>.
            </p>
