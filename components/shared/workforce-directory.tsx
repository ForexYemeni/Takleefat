 ...
 * ------------------------------------------------
 * الجولة 46 — متاح لكل مستلم إداري ومشرف أطباء مباشرة (بلا شرط إذن):
 *  - audience="NURSE" (المستلم الإداري) → كل الكادر الصحي في المنصة
 *  - audience="DOCTOR" (مشرف الأطباء) → كل الأطباء في المنصة
 * بحث + تصفية بالتخصص/الحالة + بطاقات غنية + زر السيرة الذاتية لكل شخص —
 * والمستندات الرسمية لا تُعرض هنا (حالاتها فقط في السيرة الكاملة).
...
const COPY = {
  NURSE: {
    title: 'دليل الكادر الصحي في المنصة',
    subtitle: 'جميع الكوادر في المنصة — بياناتهم المهنية معروضة والمستندات الرسمية محفوظة الخصوصية (تظهر حالات المراجعة فقط)',
  ...
  DOCTOR: {
    ...
    subtitle: 'جميع الأطباء في المنصة — بياناتهم المهنية معروضة والمستندات الرسمية محفوظة الخصوصية (تظهر حالات المراجعة فقط)',
    searchPlaceholder: 'ابحث بالاسم...',
